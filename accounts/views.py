...
def search(request):
    if request.method=='POST':
        ...
        if (srch4!="1"):
            if (srch or srch2 or (srch3!="Min_players")):
                games = search_game_sql(srch,srch2,srch3,srch4,srch7)
                if games:
